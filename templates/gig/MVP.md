...
> Product discovery document. Generated by the MVP interview during `/gig:init mvp` or `/gig:milestone mvp`.
...
<!-- Unresolved items flagged during the MVP interview. Surface these during milestone spec elicitation. -->
